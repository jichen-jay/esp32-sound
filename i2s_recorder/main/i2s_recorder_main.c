...
// --- START: Hard-coded values (NOT RECOMMENDED FOR PRODUCTION) ---
#define I2S_MIC_CLK_GPIO 14       // Your SCLK pin
#define I2S_MIC_DATA_GPIO 33      // Your DOUT pin
#define I2S_MIC_SAMPLE_RATE 16000 // Corrected sample rate to avoid errors
...
void init_microphone(void)
{
    ...
    i2s_pdm_rx_config_t pdm_rx_cfg = {
        .clk_cfg = I2S_PDM_RX_CLK_DEFAULT_CONFIG(I2S_MIC_SAMPLE_RATE), // Using corrected sample rate
#if SOC_I2S_SUPPORTS_PDM2PCM
...
#endif
        .gpio_cfg = {
            .clk = I2S_MIC_CLK_GPIO,  // Using hard-coded CLK pin
            .din = I2S_MIC_DATA_GPIO, // Using hard-coded DATA pin
            .invert_flags = {
                .clk_inv = false,
            },
        },
